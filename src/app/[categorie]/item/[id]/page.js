...
export default async function Art({ params }){
    ...
    return(
        <>   
            <Navbar />
            <SpecificArticle stock={article.stock} sizeInStock={article.sizeInStock} pointureInStock={article.pointureInStock} title={article.title} price={article.price}  mainImage={article.mainImage} images={article.images} id={article._id} />
        </>
    )
}